...
class AuthShop(Model):
    ...
    website_link = models.CharField(verbose_name='Website', blank=True, null=True, default=None, max_length=255)
    facebook_link = models.CharField(verbose_name='Facebook', blank=True, null=True, default=None, max_length=255)
    twitter_link = models.CharField(verbose_name='Twitter', blank=True, null=True, default=None, max_length=255)
    instagram_link = models.CharField(verbose_name='Instagram', blank=True, null=True, default=None, max_length=255)
