    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default=None, null=True, upload_to=auth_shop.models.get_avatar_path, verbose_name='Avatar')),
                ('avatar_thumbnail', models.ImageField(blank=True, default=None, null=True, upload_to=auth_shop.models.get_avatar_path, verbose_name='Avatar')),
                ('color_code', models.CharField(blank=True, default=None, max_length=20, null=True, verbose_name='Color code')),
                ('font_name', models.CharField(blank=True, default=None, max_length=20, null=True, verbose_name='Font name')),
                ...
                ('opening_days', models.ManyToManyField(blank=True, related_name='temp_shop_opening_days', to='auth_shop.Days', verbose_name='Opening days')),
            ],
            options={
