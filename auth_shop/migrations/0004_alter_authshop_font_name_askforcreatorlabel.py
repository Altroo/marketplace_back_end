    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_shop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auth_shop_creator', to='auth_shop.authshop', unique=True, verbose_name='Boutique')),
            ],
            options={
