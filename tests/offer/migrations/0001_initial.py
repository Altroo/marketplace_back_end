...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nbr_vue', models.PositiveIntegerField(blank=True, default=0, null=True, verbose_name='Nbr Vue')),
                ('created_date', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='Created date')),
                ('offer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='offer_vue', to='offer.offers', verbose_name='Offer')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='offers',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='offer_tags', to='offer.offertags', verbose_name='Offer Tags'),
        ),
        migrations.CreateModel(
            name='Delivery',
            fields=[
