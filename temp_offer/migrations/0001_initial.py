...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('temp_delivery_city_1', models.CharField(blank=True, default=None, max_length=300, null=True, verbose_name='Temp Delivery City 1')),
                ('temp_delivery_price_1', models.FloatField(default=0.0, verbose_name='Temp delivery Price 1')),
                ('temp_delivery_days_1', models.PositiveIntegerField(default=0, verbose_name='Temp number of Days 1')),
                ('temp_delivery_city_2', models.CharField(blank=True, default=None, max_length=300, null=True, verbose_name='Temp Delivery City 2')),
                ('temp_delivery_price_2', models.FloatField(default=0.0, verbose_name='Temp delivery Price 2')),
                ('temp_delivery_days_2', models.PositiveIntegerField(default=0, verbose_name='Temp number of Days 2')),
                ('temp_delivery_city_3', models.CharField(blank=True, default=None, max_length=300, null=True, verbose_name='Temp Delivery City 3')),
                ('temp_delivery_price_3', models.FloatField(default=0.0, verbose_name='Temp delivery Price 3')),
                ('temp_delivery_days_3', models.PositiveIntegerField(default=0, verbose_name='Temp number of Days 3')),
                ('temp_offer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='temp_offer_delivery', to='temp_offer.tempoffers', verbose_name='Temp offer')),
            ],
            options={
